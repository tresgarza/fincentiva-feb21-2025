        ...
        <div className="relative p-1 rounded-xl bg-gradient-to-r from-[#40E0D0] via-[#4DE8B2] to-[#3FD494] overflow-hidden">
          ...
          <div className="relative bg-[#0D1117] rounded-xl p-6 lg:p-8">
            ...
            <p className="text-sm text-n-4 mb-4 text-center">
              Ingresa tus datos para calcular tu plan de pagos
            </p>
                ...
                <div className="bg-[#1A1F26] border border-[#2D3643] rounded-lg p-3">
                  <div className="flex items-start gap-3">
                    <div className="flex items-center h-5">
                      <input
                        type="checkbox"
                        id="employment-checkbox-product"
                    ...
                    <div className="flex-1">
                      <label htmlFor="employment-checkbox-product" className="text-sm text-n-1 cursor-pointer">
